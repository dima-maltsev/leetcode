...
{
    // [Easy][LinkedList] https://leetcode.com/problems/intersection-of-two-linked-lists/
    public class IntersectionOfTwoLinkedLists
    {
        ...
        ListNode GetIntersectionNode(ListNode headA, ListNode headB)
        {
            ...
            var currB = headB;
            while (currB != null && !map.Contains(currB))
            {
                currB = currB.next;
            }
        ...
        {
            var headA = ArrayToLinkedList(listA);
            var headB = ArrayToLinkedList(listB);
            ...
            var nextA = NextElementAt(headA, skipA);
            var nextB = NextElementAt(headB, skipB);
        ...
        int NextElementAt(ListNode head, int index)
        {
            var i = 0;
            var curr = head;
            while (i++ < index)
